...
const engagementPresets = {
  ...
  'the-trespass': {
    ...
    commentTexts: [
      'this made my skin go cold',
      'the boundary language is exact',
      'I had to stop after the waking section',
      '@maris read this only when you have space',
      'the sheets keep their witness. god.',
      'quiet horror is worse sometimes',
      'this did not soften anything and I respect that',
      'the body remembers before the mind. yes.',
      'I feel sick in a way that means it worked',
      '@dane this is difficult but important',
      'the house with no doors line got me',
      '🫥',
      'there is nothing harmless about that',
      'I wish more people understood this language',
      'this felt like a locked room',
      'done mistaking quiet for peace. exactly.',
      'the aftermath as grief is the part nobody says',
      '@rowan please read this later',
      'hard read. necessary read.',
      '🕯️',
      'that final stanza is ice cold',
      'this one leaves marks',
    ],
    names: ['maris', 'dane', 'rowan', 'selah', 'mika', 'alix', 'tess', 'heath', 'bria', 'oren', 'mae', 'sylvie'],
    startTime: '2026-05-23T03:27:00-04:00',
    endTime: '2026-05-24T19:06:00-04:00',
  },
  'your-love-like-mold': {
  ...
  'only-the-darkness-knows': {
    ...
    commentTexts: [
      'the mouth full of lead line is awful in the exact way',
      'this felt like reading a medical chart for the soul',
      'pressure without a surface. yes.',
      '@maeve this is the one I meant',
      'the arithmetic section made my stomach drop',
      'a continent of static is going to stay with me',
      'this is not sadness, it is corrosion',
      'the canceled signal image is brutally clean',
      'I had to stop at every nerve was overfunded',
      '@oren read this when the room is quiet',
      'low voltage ending. no notes.',
      'this makes endurance sound contaminated',
      '🕳️',
      'the factory stanza felt too familiar',
      'private inventory is such a sharp phrase',
      'I hate how accurate the smiling discipline part is',
      'this one feels like fluorescent light at midnight',
      '@lina this explains what I could not say',
      'not comfort, not peace, just recognition',
      '🖤',
      'the polished people line cut deep',
      'Only the darkness knows. exactly.',
    ],
    names: ['maeve', 'oren', 'lina', 'solen', 'bram', 'vesta', 'ira', 'mabli', 'cai', 'seren', 'ottilie', 'hollis'],
  ...
  'the-shape-of-my-undoing': {
    ...
    commentTexts: [
      'the altar and knife line is vicious',
      'this felt like being named by a storm',
      'I am the slow disaster. yeah.',
      '@cerys this is heavy but read it',
      'rage like a buried bell is perfect',
      'the loneliness section hurt badly',
      'not clean, not free. that ending.',
      'I saved this and immediately regretted needing it',
      'the private trial line got me',
      '@nico this is the one I mentioned',
      'feather by feather knocked the air out of me',
      '🥀',
      'there is no clean name for this kind of ache',
      'this feels ancient and current at the same time',
      'He was overthrown. damn.',
      'the cadence is brutal',
      'I had to reread the last section',
      '@suri read this somewhere quiet',
      'this is what survival costs',
      'the darkness stayed. exactly.',
      '🕯️',
      'I feel seen and I hate it',
    ],
    names: ['cerys', 'nico', 'suri', 'arden', 'faye', 'laz', 'mara', 'ivo', 'taliah', 'reece', 'nyx', 'simon'],
    startTime: '2026-05-25T10:12:00-04:00',
    endTime: '2026-05-26T04:19:00-04:00',
  },
} as const
